<#
 ...
 USAGE
   ...
   .\Get-SPOInventory.ps1 -SiteUrl https://rightpoint.sharepoint.com -UserName kkakanur@rightpoint.com -Password pass@word  -OutputFile C:\Rightpoint\SiteInventory.csv   
