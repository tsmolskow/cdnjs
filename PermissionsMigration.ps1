...
$spousername = "" #Provide Sharepoint Username
$spopassword = "" #Provide SharePoint Password
$inputCSV = "C:\Reports\SitePermissions_2020-09-25-19-53-30-39.csv"
...
$siteURLSfile = Join-Path $executingScriptDirectory "inputFile_URLS.csv"
$intCntSite = 0
