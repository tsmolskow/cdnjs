...
## sgMigrateCopySpecificGroups2.ps1
...
foreach ($row in $table)
{
    ...
    try {
        ...
        $CopyGroups = Copy-Group -Name $groupsList -SourceSite $spoSiteSG -DestinationSite $spopSiteSG -MappingSettings $mappingSettings # Specific Groups
