...
$inputFile = "eyimdISR-0025726-MM_20210601111902.csv"
...
# Banner Level - "Read" for Red Banner, "Contribute" for Gray Banner
$BannerLevel1 = "Contribute"
$BannerLevel2 = "Contribute;"
...
foreach ($row in $table)
{
    ...
    try{
        ...
        ## Process List\Library ##
            ...
            Write-Host "List Name: " $ListName | Out-File -FilePath $reportFile -Append

            $UserAccount = $row.Accountname
            Write-Host "User Account: " $UserAccount | Out-File -FilePath $reportFile -Append

            $PermissionLevel = $row.ContentPermissions -replace ";",""
            ...
            function Grant-PermissionToList($WebUrl, $ListName, $UserAccount, $PermissionLevel)
            {
                ...
                if ($List -ne $null)
                {
                    ...
                    $User = $web.SiteGroups[$UserAccount]
                    Write-Host "User: " $User  | Out-File -FilePath $reportFile -Append
                    ...
                    Write-Host "assignment2: " $assignment  | Out-File -FilePath $reportFile -Append

                    $assignment.RoleDefinitionBindings.Add($role)
                    Write-Host "assignment3: " $assignment  | Out-File -FilePath $reportFile -Append
            ...
            Remove-PermissionFromList $WebUrl $ListName $UserAccount $BannerLevel1 
