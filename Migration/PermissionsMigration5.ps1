...
## Login Information
#$spousername = "ey\P.AUSPORTMIGP.10@ey.com" 
...
#$siteURLSfile = Join-Path $filePath "inputFile_URLS1.csv"
$intCntSite = 0
...
Try{#$accName= $RoleAssignment.Member.LoginName 
    if(($RoleAssignment.Member.PrincipalType -eq "SharePointGroup") -or ($RoleAssignment.Member.PrincipalType -eq "SecurityGroup") -or ($RoleAssignment.Member.PrincipalType -eq "User"))
         {      $ReadRole = “Read”
                ...
                $selColumns = "ID","fk_batch","Type","Name","URL","Inheritance","User/Group","Principaltype","Accountname","Permissions","TargetURL","DesURL"	
