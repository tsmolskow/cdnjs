...
$CSVPath = $ReportPath + $ID + "spopInventoryS" + "_dt" + $(get-date -f dd_MM_yyyy_HH_mm_ss) + ".csv"
    ...
    Try {  
        ...
        Write-host -f Green " GetAllSPOLists.ps1: List Inventory - " $SiteUrl "Exported to CSV!" $CSVPath
