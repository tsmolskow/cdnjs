...
##             :   - added 'support' for SP 2019 ( not much has changed here, just check the build version and create SP2019 based file )
##             :   - fixed a few typo's
##             :   - added a check to see if the SSA or SSA Proxy is 'UnPartitioned'
## Change log  : 1.7 [acasilla| jeremywa][joroar]
##             :   - made a couple changes for code efficiencies.. 
##             :   - changed the order of a couple function calls
