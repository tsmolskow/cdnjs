...
$SPSiteUrl = "https://bentest.bhcorp.ad/sites/regulatory3"
$SPSite = New-Object Microsoft.SharePoint.SPSite($SPSiteUrl);
$ExportFile = "F:\Scripts\Reports\SharePoint_Permission_Report_New_" + $(get-date -f dd_MM_yyyy) +".csv" 
...
Write-Host "Report Completed - Reporte located at" + $ExportFile
