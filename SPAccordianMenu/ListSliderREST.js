...
$(function () {    
	$.ajax({
		url: "/gas-engineering/_api/web/lists/GetByTitle('Accordion Navigation')/items?$orderby=LVL2Sequence",      
		type: "GET",
		headers: {
		...
		$.each(data.d.results, function (key, value) {                          
		   if(value.Level == 1){             
			 if(value.LVL1Sequence == 1){
			  listItemInfo += "<li><a href='" + value.Link + "' style='padding-left:24px;'>" + value.Title + "</a><ul>";                                 
			 }             
		   }                           
		}); 
		...
		$.each(data.d.results, function (key, value) {                          
		   if(value.Level == 1){            
			 if(value.LVL1Sequence == 2){ 
			  listItemInfo += "</ul></li><li><a href='" + value.Link + "' style='padding-left:24px;'>" + value.Title + "</a><ul>";                                 
			 }             
		   }                           
		}); 
