<!-- List Slider REST Start -->

<script type="text/javascript" src="/sites/Regulatory/SiteAssets/JavaScript/jquery-1.11.3.min.js"></script>
<script type="text/javascript" src="/sites/Regulatory/SiteAssets/JavaScript/jquery.SPServices-2014.02.js"></script>
<script type="text/javascript">

$(function () {    
    $.ajax({
        url: "/sites/regulatory/Colorado/2019COGRR/_api/web/lists/GetByTitle('Navigation')/items?$orderby=LVL2Sequence",          
        type: "GET",
        headers: {
        ...
        $.each(data.d.results, function (key, value) {                          
           if(value.Level == 1){             
             if(value.LVL1Sequence == 1){
              listItemInfo += "<li><a href='#' style='padding-left:24px;'>" + value.Title + "</a><ul>";                                 
             }             
           }                           
        }); 
        ...
        $.each(data.d.results, function (key, value) {                          
           if(value.Level == 1){            
             if(value.LVL1Sequence == 2){ 
              listItemInfo += "</ul></li><li><a href='#' style='padding-left:24px;'>" + value.Title + "</a><ul>";                                 
             }             
           }                           
        }); 
        ...
        $.each(data.d.results, function (key, value) {                          
           if(value.Level == 1){            
             if(value.LVL1Sequence == 5){
              listItemInfo += "</ul></li><li><a href='#' style='color:orange;'>" + value.Title + "</a><ul>";                                 
             }             
           }                           
        });            
